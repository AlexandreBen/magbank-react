...
const AccountPayments = () => (
    ...
    <>
        <Col xs={12} lg={6} className="mt-lg-5 pt-lg-5">
                <h3 className="mt-4 texto-top">Pagamentos</h3>
                <Tabs className="pt-lg-8" >
                    <Tab eventKey='boleto' title='Boleto' defaultActiveKey='latest'>
                    <Form>
                        <Form.Group className="my-5" controlId="formBarCode">
                            <Form.Label>Codigo de barras</Form.Label>
                            <Form.Control type="number" placeholder="Insira o código de barras" />
                        </Form.Group>
                        <Form.Group controlId='formPaimentType' className="mb-3">
                            <Form.Label>Forma de Pagamentos</Form.Label>
                    ...
                    <Tab className="dashboard__table" eventKey='transfer' title='Transferência'>
                    <Form.Group className="d-flex" controlId="formBarCode">
                    <Col xs={12} lg={5} className="mt-lg-5">
                            ...
                            <Col xs={12} lg={5} className="mt-lg-5 m-3">
                                <Form.Label>Agência</Form.Label>
                                <Form.Control type="number" placeholder="Insira o código da agência" />
                            </Col>
                            <Col xs={12} lg={5} className="mt-lg-5">
                                <Form.Label>Conta Corrente</Form.Label>
                                <Form.Control type="number" placeholder="Insira a Conta Corrente" />
                            </Col>
                    ...
                    <Col xs={12} lg={5} className="mt-lg-5 m-3">
                        ...
                        <Form.Control type="number" placeholder="Insira o valor" />
                    </Col>
                    <Col xs={12} lg={5} className="mt-lg-5 m-3">
                        <Form.Label>Identificação no Extrato</Form.Label>
